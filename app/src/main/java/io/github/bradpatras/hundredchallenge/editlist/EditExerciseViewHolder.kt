...
class EditExerciseViewHolder(itemView: View, titleChangeListener: ((String, EditExerciseViewHolder) -> Unit), repCountChangeListener: ((String, EditExerciseViewHolder) -> Unit)) : RecyclerView.ViewHolder(itemView) {
